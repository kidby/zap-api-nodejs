...
class Automation {
   ...
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} - A promise that resolves with the plan progress details.
   */
  planProgress = ({ planId }) =>
   ...
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} - A promise that resolves when the plan is started.
   */
  runPlan = ({ filePath }) =>
   ...
   *
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} - A promise that resolves when the delay job is ended.
   */
  endDelayJob = () =>
