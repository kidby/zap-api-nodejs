...
class Script {
   ...
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving with the list of script engines.
   */
  listEngines = () => this.api.request('/script/view/listEngines');

  /**
   * Lists the script types available.
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving with the list of script types.
   */
   ...
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving with the list of scripts.
   */
   ...
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving with the global variable value.
   */
   ...
   * @param {{ varKey: string }} args - Object containing the key.
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving with the global custom variable value.
   */
  globalCustomVar = ({ varKey }) => this.api.request('/script/view/globalCustomVar', { varKey });

  /**
   * Gets all global variables (key/value pairs).
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving with all global variables.
   */
  globalVars = () => this.api.request('/script/view/globalVars');

  /**
   * Gets all global custom variables (key/value pairs).
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving with all global custom variables.
   */
   ...
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving with the script variable value.
   */
   ...
   * @param {{ scriptName: string, varKey: string }} args - Object containing the script name and variable key.
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving with the script custom variable value.
   */
   ...
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving with the script variables.
   */
   ...
   * @param {{ scriptName: string }} args - Object containing the script name.
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving with the script custom variables.
   */
   ...
   * @param {{ scriptName: string }} args - Object containing the script name.
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving when the script is enabled.
   */
   ...
   * @param {{ scriptName: string }} args - Object containing the script name.
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving when the script is disabled.
   */
   ...
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving with the load result.
   */
   ...
   * @param {{ scriptName: string }} args - Object containing the script name.
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving when the script is removed.
   */
  remove = ({ scriptName }) =>
   ...
   * @param {{ scriptName: string }} args - Object containing the script name.
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving with the run result.
   */
   ...
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving when the global variable is cleared.
   */
   ...
   * @param {{ varKey: string }} args - Object containing the variable key.
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving when the global custom variable is cleared.
   */
   ...
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving when all global variables are cleared.
   */
  clearGlobalVars = () =>
   ...
   * @param {{ scriptName: string, varKey: string }} args - Object containing the script name and variable key.
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving when the script variable is cleared.
   */
   ...
   * @param {{ scriptName: string, varKey: string }} args - Object containing the script name and variable key.
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving when the script custom variable is cleared.
   */
   ...
   * @param {{ scriptName: string }} args - Object containing the script name.
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving when the script variables are cleared.
   */
   ...
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving when the variable is set.
   */
   ...
   * @returns {ZAProxy.ZapApiPromiseResponse<string>} A promise resolving when the global variable is set.
   */
